	...
	return declare([ScrollableView], {
		...
		startup: function () {
			...
			this.selectSwitch = registry.byId("select");
                        this.feedSelect = registry.byId("feedSelectId");
			...
			registry.byId("doneButton").on("click", lang.hitch(this, function () {
				...
				if (this.getTags() !== flickrview.QUERY.tags ||
					...
					this.feedView.refresh()
                        ...
                        registry.byId("homeViewBack").on("click", lang.hitch(this, function () {
                            this.feedSelect.set("selected", "true");
                            this.feedSelect.transitionTo("feed");
                            this.feedSelect.set("transition","slide");
                            this.feedSelect.set("transitionDir",-1);
                        } ));
